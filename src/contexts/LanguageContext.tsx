...
const translations: Translations = {
  ja: {
    ...
    // CharacterCount translations
    'characterCount.input.label': 'テキストを入力',
    'characterCount.input.placeholder': '文字数をカウントしたいテキストを入力してください...',
    'characterCount.settings': '設定',
    'characterCount.includeSpaces': 'スペースを含む',
    'characterCount.includeNewlines': '改行を含む',
    'characterCount.result': 'カウント結果',
    'characterCount.characters': '文字',
    'characterCount.words': '単語',
    'characterCount.lines': '行',
    'characterCount.japaneseChars': '日本語',
    'characterCount.totalWithSpaces': '全体（スペース込み）',
    'characterCount.excludeSpaces': 'スペース除外',
    'characterCount.excludeNewlines': '改行除外',
    'characterCount.excludeSpacesNewlines': 'スペース・改行除外',
    'characterCount.copyResult': '結果をコピー',
    'characterCount.copied': 'コピー済み',
    'characterCount.reset': 'リセット',
    ...
    'randomGenerator.preset.pin': 'PIN',
    'randomGenerator.preset.token': 'トークン',
    'randomGenerator.length.label': '文字数',
    'randomGenerator.charTypes.label': '使用する文字種',
    'randomGenerator.charTypes.numbers': '数字 (0-9)',
    'randomGenerator.charTypes.uppercase': '大文字 (A-Z)',
    'randomGenerator.charTypes.lowercase': '小文字 (a-z)',
    'randomGenerator.charTypes.symbols': '記号',
    ...
    'uuidGenerator.copied': 'コピー済み',
    'uuidGenerator.description.v4': '完全にランダムな値を使用',
    'uuidGenerator.description.v1': 'タイムスタンプベース（簡易実装）',
    'uuidGenerator.historyOutput.single': 'UUID {version}',
    'uuidGenerator.historyOutput.multiple': '{count}個のUUID {version}',
    'uuidGenerator.historyOutput.generated': '{count}個生成',
  ...
  en: {
    ...
    // CharacterCount translations
    'characterCount.input.label': 'Enter text',
    'characterCount.input.placeholder': 'Enter the text you want to count characters for...',
    'characterCount.settings': 'Settings',
    'characterCount.includeSpaces': 'Include spaces',
    'characterCount.includeNewlines': 'Include newlines',
    'characterCount.result': 'Count Results',
    'characterCount.characters': 'Characters',
    'characterCount.words': 'Words',
    'characterCount.lines': 'Lines',
    'characterCount.japaneseChars': 'Japanese',
    'characterCount.totalWithSpaces': 'Total (with spaces)',
    'characterCount.excludeSpaces': 'Exclude spaces',
    'characterCount.excludeNewlines': 'Exclude newlines',
    'characterCount.excludeSpacesNewlines': 'Exclude spaces & newlines',
    'characterCount.copyResult': 'Copy result',
    'characterCount.copied': 'Copied',
    'characterCount.reset': 'Reset',
    ...
    'jsonFormatter.stats.booleans': 'Booleans',
    'jsonFormatter.usage.title': 'How to use',
    'jsonFormatter.usage.step1': 'Paste the JSON string you want to format in the textarea above',
    'jsonFormatter.usage.step2': 'Syntax errors will be automatically detected and displayed',
    'jsonFormatter.usage.step3': 'Change indent size to adjust readability',
    'jsonFormatter.usage.step4': 'Use "Compress" button to create minified version without spaces and newlines',
    'jsonFormatter.copied': 'Copied',
    ...
    'baseConverter.format.base58.example': 'Example: "Hello" → "9Ajdvzr"',
    'baseConverter.usage.title': 'Usage examples',
    'baseConverter.usage.base64': 'Email attachments, data URLs, Basic authentication',
    'baseConverter.usage.base64url': 'JWT, OAuth, URL-safe strings',
    'baseConverter.usage.base58': 'Bitcoin, IPFS, shortened URLs',
    'baseConverter.copied': 'Copied',
    'baseConverter.historyOutput.encode': '{format} encode completed',
    'baseConverter.historyOutput.decode': '{format} decode completed',
    ...
    'textConverter.target.all': 'All',
    'textConverter.target.numbers': 'Numbers only',
    'textConverter.target.alphabet': 'Alphabet only',
    'textConverter.target.katakana': 'Katakana only',
    'textConverter.input.label': 'Text before conversion',
    'textConverter.input.placeholder': 'Enter text to convert...',
    'textConverter.output.label': 'Text after conversion',
    'textConverter.button.copyResult': 'Copy result',
    'textConverter.button.reset': 'Reset',
    'textConverter.examples.title': 'Conversion examples',
    'textConverter.examples.numbers': 'Numbers: １２３４５ ⇔ 12345',
    'textConverter.examples.alphabet': 'Alphabet: ＡＢＣＤＥ ⇔ ABCDE',
    'textConverter.examples.katakana': 'Katakana: アイウエオ ⇔ ｱｲｳｴｵ',
    'textConverter.examples.symbols': 'Symbols: （）「」！？ ⇔ ()「」!?',
    'textConverter.copied': 'Copied',
    ...
    'randomGenerator.preset.pin': 'PIN',
    'randomGenerator.preset.token': 'Token',
    'randomGenerator.length.label': 'Length',
    'randomGenerator.charTypes.label': 'Character types',
    'randomGenerator.charTypes.numbers': 'Numbers (0-9)',
    'randomGenerator.charTypes.uppercase': 'Uppercase (A-Z)',
    'randomGenerator.charTypes.lowercase': 'Lowercase (a-z)',
    'randomGenerator.charTypes.symbols': 'Symbols',
    ...
    'uuidGenerator.copied': 'Copied',
    'uuidGenerator.description.v4': 'Uses completely random values',
    'uuidGenerator.description.v1': 'Timestamp-based (simplified implementation)',
    'uuidGenerator.historyOutput.single': 'UUID {version}',
    'uuidGenerator.historyOutput.multiple': '{count} UUIDs {version}',
    'uuidGenerator.historyOutput.generated': '{count} generated',
    ...
    'hashGenerator.usage.title': 'Usage examples',
    'hashGenerator.usage.integrity': 'File integrity check: Verify downloaded files are not corrupted',
    'hashGenerator.usage.password': 'Password storage: Store hash values instead of plain passwords',
    'hashGenerator.usage.signature': 'Digital signatures: Detect document tampering',
    'hashGenerator.usage.blockchain': 'Blockchain: Used in Bitcoin and other cryptocurrencies',
    'hashGenerator.historyOutput': 'Hash generation completed',
    ...
    'yamlJsonConverter.features.yamlToJson': 'YAML → JSON: Convert YAML format to JSON format',
    'yamlJsonConverter.features.jsonToYaml': 'JSON → YAML: Convert JSON format to YAML format',
    'yamlJsonConverter.features.realtime': 'Real-time conversion: Automatic conversion as you type',
    'yamlJsonConverter.features.swap': 'Input/output swap: Reuse conversion results as input',
    'yamlJsonConverter.features.errorDetection': 'Error detection: Detailed display of syntax errors',
    'yamlJsonConverter.historyOutput.yaml': 'YAML text',
    'yamlJsonConverter.historyOutput.json': 'JSON text',
    'yamlJsonConverter.historyOutput.yamlToJson': 'Converted to JSON',
    'yamlJsonConverter.historyOutput.jsonToYaml': 'Converted to YAML',
